...
public:
    ...
    {
        KeyValues* pFind = FindKey(keyname, false);
        if (pFind)
        {
            CDATA return_value;
    ...
    bool LoadFromBuffer(KeyValues* pThis, const char* pszFirst, const char* pszSecond, void* pSomething = 0, void* pAnother = 0, void* pLast = 0, void* pAnother2 = 0);
