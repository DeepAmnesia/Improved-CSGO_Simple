        ...
        switch(class_id) {
            case ClassId_CCSPlayer:
            {
                ...
                if(entity->HasC4() && is_enemy && g_Configurations.glow_c4_carrier) {
                    color = g_Configurations.color_glow_c4_carrier;
                    break;
                }
                ...
                color = is_enemy ? g_Configurations.color_glow_enemy : g_Configurations.color_glow_ally;
            ...
            case ClassId_CChicken:
                ...
                color = g_Configurations.color_glow_chickens;
                break;
            case ClassId_CBaseAnimating:
                if(!g_Configurations.glow_defuse_kits)
                    continue;
                color = g_Configurations.color_glow_defuse;
                break;
            case ClassId_CPlantedC4:
                if(!g_Configurations.glow_planted_c4)
                    continue;
                color = g_Configurations.color_glow_planted_c4;
                break;
            default:
            {
                if(entity->IsWeapon()) {
                    if(!g_Configurations.glow_weapons)
                        continue;
                    color = g_Configurations.color_glow_weapons;
                }
            }
        }
